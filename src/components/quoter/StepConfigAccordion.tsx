...
const assets = import.meta.glob("@/assets/**/*.{jpg,jpeg,png}", {
  eager: true,
  query: "?url",
  import: "default",
...
const PACKAGE_ASSETS: Record<string, { src: string; mask?: string; stolaNegro?: string }> = {
  pri_c: {
    src: getAsset("Renta/Primaria/B1/B1-base.jpg"),
    mask: getAsset("Renta/Primaria/B1/B1-estola-base.png"),
    stolaNegro: getAsset("Renta/Primaria/B1/B1-estola-negro.png"),
  },
  pri_b: {
    src: getAsset("Renta/Primaria/B2/B2-base.jpg"),
    mask: getAsset("Renta/Primaria/B2/B2-estola-base.png"),
    stolaNegro: getAsset("Renta/Primaria/B2/B2-estola-negro.png"),
  },
  pri_a: {
    src: getAsset("Renta/Primaria/B3/B3-base.jpg"),
    mask: getAsset("Renta/Primaria/B3/B3-estola-base.png"),
    stolaNegro: getAsset("Renta/Primaria/B3/B3-estola-negro.png"),
  },
  sec_b: {
    src: getAsset("Renta/Secundaria/B1/B1-base.jpg"),
    mask: getAsset("Renta/Secundaria/B1/B1-estola-base.png"),
    stolaNegro: getAsset("Renta/Secundaria/B1/B1-estola-negro.png"),
  },
  sec_a: {
    src: getAsset("Renta/Secundaria/B2/B2-base.jpg"),
    mask: getAsset("Renta/Secundaria/B2/B2-estola-base.png"),
    stolaNegro: getAsset("Renta/Secundaria/B2/B2-estola-negro.png"),
  },
  prep_b: {
    src: getAsset("Renta/Preparatoria/B1/B1-base.jpg"),
    mask: getAsset("Renta/Preparatoria/B1/B1-estola-base.png"),
    stolaNegro: getAsset("Renta/Preparatoria/B1/B1-estola-negro.png"),
  },
  prep_a: {
    src: getAsset("Renta/Preparatoria/B2/B2-base.jpg"),
    mask: getAsset("Renta/Preparatoria/B2/B2-estola-base.png"),
    stolaNegro: getAsset("Renta/Preparatoria/B2/B2-estola-negro.png"),
  },
  prep_c1: {
    src: getAsset("Renta/Preparatoria/C1/C1-base.jpg"),
    mask: getAsset("Renta/Preparatoria/C1/C1-estola-base.png"),
    stolaNegro: getAsset("Renta/Preparatoria/C1/C1-estola-negro.png"),
  },
  prep_c2: {
    src: getAsset("Renta/Preparatoria/C2/C2-base.jpg"),
    mask: getAsset("Renta/Preparatoria/C2/C2-estola-base.png"),
    stolaNegro: getAsset("Renta/Preparatoria/C2/C2-estola-negro.png"),
  },
  uni_b: {
    src: getAsset("Renta/Universidad/B/B-base.jpg"),
    mask: getAsset("Renta/Universidad/B/B-estola-base.png"),
    stolaNegro: getAsset("Renta/Universidad/B/B-estola-negro.png"),
  },
  uni_c: {
    src: getAsset("Renta/Universidad/C/C-base.jpg"),
    mask: getAsset("Renta/Universidad/C/C-estola-base.png"),
    stolaNegro: getAsset("Renta/Universidad/C/C-estola-negro.png"),
  },
};
...
const VENTA_PREESCOLAR_PAQUETE_B: Record<string, { src: string; mask?: string }> = {
  esencial: {
    src: getAsset("Venta/Preescolar/Estolas/E1.jpg"),
    mask: getAsset("Venta/Preescolar/Estolas/E1-mask.png"),
  },
  hybrid: {
    src: getAsset("Venta/Preescolar/Estolas/E2.jpg"),
    mask: getAsset("Venta/Preescolar/Estolas/E2-mask.png"),
  },
  max: {
    src: getAsset("Venta/Preescolar/Estolas/E3.jpg"),
    mask: getAsset("Venta/Preescolar/Estolas/E3-mask.png"),
  },
};

const PREESCOLAR_PAQUETE_A: Record<string, Record<string, string>> = {
  negro: {
    dorada: getAsset("Renta/Preescolar/Paquete A/negro-dorado.jpg"),
    plateada: getAsset("Renta/Preescolar/Paquete A/negro-plata.jpg"),
    azul: getAsset("Renta/Preescolar/Paquete A/negro-azul.jpg"),
    roja: getAsset("Renta/Preescolar/Paquete A/negro-rojo.jpg"),
    default: getAsset("Renta/Preescolar/Paquete A/negro-dorado.jpg"),
  },
  azul: {
    dorada: getAsset("Renta/Preescolar/Paquete A/azul-dorado.jpg"),
    plateada: getAsset("Renta/Preescolar/Paquete A/azul-plata.jpg"),
    azul: getAsset("Renta/Preescolar/Paquete A/azul-azul.jpg"),
    roja: getAsset("Renta/Preescolar/Paquete A/azul-rojo.jpg"),
    default: getAsset("Renta/Preescolar/Paquete A/azul-dorado.jpg"),
  },
  verde: {
    dorada: getAsset("Renta/Preescolar/Paquete A/verde-dorado.jpg"),
    plateada: getAsset("Renta/Preescolar/Paquete A/verde-plata.jpg"),
    azul: getAsset("Renta/Preescolar/Paquete A/verde-azul.jpg"),
    roja: getAsset("Renta/Preescolar/Paquete A/verde-rojo.jpg"),
    default: getAsset("Renta/Preescolar/Paquete A/verde-dorado.jpg"),
  },
  turquesa: {
    dorada: getAsset("Renta/Preescolar/Paquete A/turquesa-dorado.jpg"),
    plateada: getAsset("Renta/Preescolar/Paquete A/turquesa-plata.jpg"),
    azul: getAsset("Renta/Preescolar/Paquete A/turquesa-turquesa.jpg"),
    roja: getAsset("Renta/Preescolar/Paquete A/turquesa-rojo.jpg"),
    default: getAsset("Renta/Preescolar/Paquete A/turquesa-dorado.jpg"),
  },
  rojo: {
    dorada: getAsset("Renta/Preescolar/Paquete A/rojo-dorado.jpg"),
    plateada: getAsset("Renta/Preescolar/Paquete A/rojo-plata.jpg"),
    azul: getAsset("Renta/Preescolar/Paquete A/rojo-azul.jpg"),
    roja: getAsset("Renta/Preescolar/Paquete A/rojo-rojo.jpg"),
    default: getAsset("Renta/Preescolar/Paquete A/rojo-dorado.jpg"),
  },
  magenta: {
    dorada: getAsset("Renta/Preescolar/Paquete A/turquesa-dorado.jpg"),
    plateada: getAsset("Renta/Preescolar/Paquete A/turquesa-plata.jpg"),
...
const FEATURES_VENTA_PREESCOLAR: Record<
  "esencial" | "hybrid" | "max",
  { icon: typeof Camera; text: string }[]
> = {
  esencial: [
    ...
    {
      icon: Layers,
      text: "Acabado premium: Tela satinada de alta calidad con impresión profesional.",
    },
  ],
  hybrid: [
  ...
  max: [
    ...
    {
      icon: Sparkles,
      text: "Personalización total: Nombre, logo escolar y temática personalizada.",
    },
    {
      icon: Layers,
      text: "Acabado premium: Tela satinada de alta calidad con impresión profesional.",
...
const FEATURES_VENTA_BIRRETES: Record<
  "birrete_decorado" | "birrete_liso",
  { icon: typeof Camera; text: string }[]
> = {
  birrete_decorado: [
...
const FEATURES_VENTA_BORLAS: Record<
  "borla_dije" | "borla_clasica",
  { icon: typeof Camera; text: string }[]
> = {
  borla_dije: [
    {
      icon: Camera,
      text: "Personaliza el dije con foto del alumno, logo escolar, nombre, generación o temática especial.",
    },
    {
      icon: Shirt,
      text: "Amplia variedad de colores disponibles para combinar con tu graduación.",
    },
...
export function StepConfigAccordion({
  level,
  service,
  city,
  pkg,
  ...
  const [activeAccordion, setActiveAccordion] = useState<"paquetes" | "colores" | "incluye">(
    "paquetes",
  );
  ...
  if (service === "venta" && level === "preescolar") {
    if (productCategory === "birretes") {
      features =
        FEATURES_VENTA_BIRRETES[
          (pkg?.variant as "birrete_decorado" | "birrete_liso") || "birrete_decorado"
        ] || FEATURES_A;
    } else if (productCategory === "borlas") {
      features =
        FEATURES_VENTA_BORLAS[(pkg?.variant as "borla_dije" | "borla_clasica") || "borla_dije"] ||
        FEATURES_A;
    } else if (pkg?.kind === "B" && pkg.variant) {
      features =
        FEATURES_VENTA_PREESCOLAR[pkg.variant as "esencial" | "hybrid" | "max"] || FEATURES_A;
    }
  } else if (isUni) {
    if (pkg?.kind === "A") {
  ...
  const showcaseMedia = useMemo(() => {
    let result: string | { src: string; mask?: string; stolaNegro?: string } =
      getAsset("gown-showcase.jpg");
  ...
  return (
    <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 flex-1 flex flex-col min-h-0">
      ...
      <div className="rounded-2xl border border-hairline bg-card shadow-[0_1px_2px_rgba(15,23,42,0.04),0_20px_50px_-30px_rgba(17,34,68,0.18)] flex-1 flex flex-col min-h-0 overflow-hidden relative">
        <div className="grid grid-cols-1 lg:grid-cols-[1.05fr_1fr] flex-1 min-h-0 overflow-hidden">
          {/* LEFT - Visual showcase */}
          <div className="relative bg-cream/60 h-[40vh] lg:h-full shrink-0 perspective-[1000px]">
            <motion.div
              onMouseMove={handleMouseMove}
              onMouseLeave={handleMouseLeave}
              style={{ rotateX, rotateY, transformStyle: "preserve-3d" }}
              className="w-full h-full overflow-hidden relative flex items-center justify-center p-4 lg:p-0 cursor-crosshair"
            >
                ...
                >
                  ...
                  {showcaseMedia.mask &&
                    ...
                    (() => {
                      ...
                      const stolaBg =
                        (activeStola as any)?.gradient || activeStola?.hex || "transparent";
          ...
          {/* RIGHT - Control panel */}
          <div className="p-5 sm:p-8 space-y-4 overflow-y-auto custom-scrollbar flex flex-col h-full">
            <div className="border border-border rounded-xl overflow-hidden bg-white shrink-0">
              <button
                onClick={() => setActiveAccordion("paquetes")}
                className="w-full text-left px-6 py-4 font-display text-lg bg-cream/30 hover:bg-cream/50 transition-colors flex justify-between items-center"
              >
                <span>1. Elige tu paquete</span>
                <span className="text-navy font-bold">
                  {activeAccordion === "paquetes" ? "-" : "+"}
                </span>
              </button>
              <div
                style={{ display: activeAccordion === "paquetes" ? "block" : "none" }}
                className="p-6 border-t border-border space-y-8"
              >
            ...
            <div className="border border-border rounded-xl overflow-hidden bg-white shrink-0">
              <button
                onClick={() => setActiveAccordion("colores")}
                className="w-full text-left px-6 py-4 font-display text-lg bg-cream/30 hover:bg-cream/50 transition-colors flex justify-between items-center"
              >
                <span>2. Personaliza los colores</span>
                <span className="text-navy font-bold">
                  {activeAccordion === "colores" ? "-" : "+"}
                </span>
              </button>
              <div
                style={{ display: activeAccordion === "colores" ? "block" : "none" }}
                className="p-6 border-t border-border space-y-8"
              >
                {/* Color de Toga */}
                {service !== "venta" &&
            ...
            <div className="border border-border rounded-xl overflow-hidden bg-white shrink-0">
              <button
                onClick={() => setActiveAccordion("incluye")}
                className="w-full text-left px-6 py-4 font-display text-lg bg-cream/30 hover:bg-cream/50 transition-colors flex justify-between items-center"
              >
                <span>3. �Qu� incluye?</span>
                <span className="text-navy font-bold">
                  {activeAccordion === "incluye" ? "-" : "+"}
                </span>
              </button>
              <div
                style={{ display: activeAccordion === "incluye" ? "block" : "none" }}
                className="p-6 border-t border-border space-y-8"
              >
                {/* Features */}
                <section>
        ...
        {/* Sticky footer inside flex layout */}
        <div className="border-t border-hairline bg-background/95 backdrop-blur shrink-0 z-30">
