  ...
  const fetchPricing = async () => {
    ...
    try {
      ...
      const staticKeys = [
        ...
        { key: "V_B_DECORADO", price: 250, discount_percent: 0 },
          ...
          <section className="space-y-6">
            ...
            {(() => {
              const staticKeys = [
                ...
                { key: "V_TOGA_BIRRETE_ESTOLA", service: "venta" },
                { key: "V_TOGA_BIRRETE_BORLA", service: "venta" },
                { key: "V_MEDALLA_STANDARD", service: "venta" },
                { key: "V_MEDALLA_PERSONALIZADA", service: "venta" },
                { key: "V_OSO_GRADUACION", service: "venta" },
                ...
                <div className="bg-white rounded-2xl border border-hairline shadow-sm overflow-hidden divide-y divide-hairline">
                  {(() => {
                    ...
                    const pricingMeta = [
                      ...
                      {
                        key: "V_TOGA_BIRRETE_ESTOLA",
                        service: "venta",
                        title: "Venta Preescolar — Toga Completa",
                        desc: "Incluye Toga, Birrete y Estola para Venta.",
                        levels: ["preescolar"],
                      },
                      {
                        key: "V_TOGA_BIRRETE_BORLA",
                        service: "venta",
                        title: "Venta Preescolar — Toga y Birrete con Borla",
                        desc: "Toga y birrete con borla del año, sin estola para Venta.",
                        levels: ["preescolar"],
                      },
                      {
                        key: "V_MEDALLA_STANDARD",
                        service: "venta",
                        title: "Venta Preescolar — Medalla Estándar",
                        desc: "Medalla conmemorativa clásica para Venta en nivel preescolar.",
                        levels: ["preescolar"],
                      },
                      {
                        key: "V_MEDALLA_PERSONALIZADA",
                        service: "venta",
                        title: "Venta Preescolar — Medalla Personalizada",
                        desc: "Medalla grabada personalizada con nombre y detalles para Venta.",
                        levels: ["preescolar"],
                      },
                      {
